...
public class Wordnet {
	...
	final static private File WORDNET_FILE = new File("/home/xinyu/data/wordnet/dict");
	static private IRAMDictionary dict;
	static private WordnetStemmer stemmer;

	public static void main(String[] args) throws Exception{
		Wordnet wn = new Wordnet(false);
		System.out.println(wn.stemNounFirst("thanks"));
		System.out.println(wn.stemNounFirst("people"));
		System.out.println(wn.stemNounFirst("leaves"));
	}
