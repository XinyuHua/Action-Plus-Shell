...
public class ProbaseClient{
	...
	public static void main(String[] args) throws Exception {
		ProbaseClient pc = new ProbaseClient(4501);
		System.out.println(pc.getVagueness("wine"));
		System.out.println(pc.getVagueness("person"));
		System.out.println(pc.getVagueness("sports"));
		System.out.println(pc.getVagueness("software"));
		System.out.println(pc.getVagueness("country"));

		System.out.println("------------");
		System.out.println(pc.getVagueness("factor"));
		System.out.println(pc.getVagueness("name"));
		System.out.println(pc.getVagueness("feature"));
		System.out.println(pc.getVagueness("datum"));
		System.out.println(pc.getVagueness("word"));
		System.out.println(pc.getVagueness("parameter"));
		System.out.println(pc.getVagueness("information"));
		pc.disconnect();
	}
